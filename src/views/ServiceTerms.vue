...
<template>
  <div>
    ...
    <h3><span>1. Using the App</span></h3>
    <p>
      <span
    ...
    <h3><span>2. Data Collection and Use</span></h3>
    <p>
      <span
    ...
    <h3><span>3. User Responsibilities</span></h3>
    <ul>
      <li>
        <p><span>Ensure that you have permission to grant access to the calendar;</span></p>
      </li>
      <li>
        <p>
          <span>Use the application ethically and in compliance with applicable laws;</span>
        </p>
      </li>
      <li>
        <p><span>Do not use the service for malicious or fraudulent activities.</span></p>
      </li>
    </ul>
    <h3><span>4. Limitation of Liability</span></h3>
    <p>
      <span
        >We are not responsible for any loss of data, sync failures or any damages arising from the
        use of the application. It is the user's responsibility to verify the information
        entered.</span
      >
    </p>
    <h3><span>5. Modifications to the Terms</span></h3>
    <p>
      <span
